...
Answer: *Divert it/Don't give an answer*
...
For accurate specific question answers, *qlora* seems to be best which was the purpose of this task.

Next up I will compare the 8b *qlora* with the 70b *qlora* model to see if introducing more parameters does answer all the questions correctly.
